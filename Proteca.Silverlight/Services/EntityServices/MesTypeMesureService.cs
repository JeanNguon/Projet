...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<MesTypeMesure>))]
    public class MesTypeMesureService : IEntityService<MesTypeMesure>
    {
        #region Properties
        ...
        public ObservableCollection<MesTypeMesure> Entities { get; set; }

        public MesTypeMesure DetailEntity { get; set; }
        #endregion

        #region Constructor
        public MesTypeMesureService()
        {
        }
        #endregion
        ...
        public void Add(MesTypeMesure entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(MesTypeMesure entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.MesTypeMesures.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.MesTypeMesures.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<MesTypeMesure> query = domainContext.ListMesTypeMesureEnServiceQuery().OrderBy(u => u.LibTypeMesure);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesTypeMesure> MesTypeMesures = null;
                ...
                {
                    MesTypeMesures = loadOp.Entities;
                    Entities = new ObservableCollection<MesTypeMesure>(MesTypeMesures.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<MesTypeMesure> query = domainContext.GetMesTypeMesureByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<MesTypeMesure>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<MesTypeMesure, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);

            EntityQuery<MesTypeMesure> query = domainContext.GetMesTypeMesureQuery();
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesTypeMesure> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<MesTypeMesure>(entities.ToList());
                }
        ...
        /// <summary>
        /// Retourne une liste de type de mesure
        /// </summary>
        /// <param name="Listcle">liste de clé de type de mesure</param>
        /// <param name="completed">fonction de retour</param>
        public void GetListMesTypeMesureOnly(List<int> Listcle, Action<Exception, IEnumerable<MesTypeMesure>> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<MesTypeMesure> query = domainContext.FindMesTypeMesuresByListCleQuery(Listcle);
