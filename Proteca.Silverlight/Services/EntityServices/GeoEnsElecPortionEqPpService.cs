...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<GeoEnsElecPortionEqPp>))]
    public class GeoEnsElecPortionEqPpService : IEntityService<GeoEnsElecPortionEqPp>
    {
        #region Properties
        ...
        public ObservableCollection<GeoEnsElecPortionEqPp> Entities { get; set; }

        public GeoEnsElecPortionEqPp DetailEntity { get; set; }
        #endregion

        #region Constructor
        
        public GeoEnsElecPortionEqPpService()
        {
            Entities = new ObservableCollection<GeoEnsElecPortionEqPp>();
        }
        ...
        public void Add(GeoEnsElecPortionEqPp entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(GeoEnsElecPortionEqPp entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<GeoEnsElecPortionEqPp, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<GeoEnsElecPortionEqPp> query = domainContext.GetGeoEnsElecPortionEqPpNoTrackingQuery().OrderBy(e => e.Id);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                ...
                Exception error = null;
                IEnumerable<GeoEnsElecPortionEqPp> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<GeoEnsElecPortionEqPp>(entities.ToList());
                }
