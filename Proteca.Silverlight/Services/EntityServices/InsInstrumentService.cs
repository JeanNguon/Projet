...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    public class InsInstrumentService : IEntityService<InsInstrument>
    {
        ...
        public void Clear()
        {
            this.domainContext.InsInstruments.Clear();
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<InsInstrument> query = domainContext.GetInsInstrumentByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<InsInstrument>(loadOp.Entities);
                    }
                }
        ...
        public void FindInstrumentsByCriterias(int cleRegion, int? cleAgence, int? cleSecteur, bool includeDeleted, Action<Exception> completed)
        {
            ...
            EntityQuery<InsInstrument> query = domainContext.FindInsInstrumentByGeoQuery(cleRegion, cleAgence, cleSecteur, includeDeleted);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                {
                    InsInstruments = loadOp.Entities;
        ...
        /// <summary>
        /// Retrouve les instruments utilisés par une liste d'instruments
        /// </summary>
        /// <param name="clesInsInstrument"></param>
        /// <param name="completed"></param>
        public void GetInsInstrumentUtilisesByListInsInstrument(List<int> clesInsInstrument, Action<Exception, IEnumerable<int>> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);

            domainContext.GetInsInstrumentUtilisesByListInsInstrument(clesInsInstrument, invOp =>
            {
                // Declare error and result
                Exception error = null;
        ...
        /// <summary>
        /// Retrouve des instruments par clé tournée
        /// </summary>
        ...
        public void FindInsInstrumentByCleTournee(int cleTournee, Action<Exception> completed)
        {
            ...
            EntityQuery<InsInstrument> query = domainContext.FindInsInstrumentByCleTourneeQuery(cleTournee);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
        ...
        public void FindInsInstrumentByGeoSecteur(int cleSecteur, Action<Exception> completed)
        {
            ...
            EntityQuery<InsInstrument> query = domainContext.FindInsInstrumentByGeoSecteurQuery(cleSecteur);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
        ...
        public void GetListInstrumentOnly(List<int> Listcle, Action<Exception, IEnumerable<InsInstrument>> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<InsInstrument> query = domainContext.FindInstrumentsByListCleQuery(Listcle);
