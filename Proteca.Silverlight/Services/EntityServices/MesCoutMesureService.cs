...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<MesCoutMesure>))]
    public class MesCoutMesureService : IEntityService<MesCoutMesure>
    {
        #region Properties
        ...
        public ObservableCollection<MesCoutMesure> Entities { get; set; }

        public MesCoutMesure DetailEntity { get; set; }
        #endregion

        #region Constructor
        public MesCoutMesureService()
        {
            Entities = new ObservableCollection<MesCoutMesure>();
        }
        #endregion
        ...
        public void Add(MesCoutMesure entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(MesCoutMesure entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void Clear()
        {
            domainContext.MesCoutMesures.Clear();
            this.Entities = new ObservableCollection<MesCoutMesure>();
        }
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.MesCoutMesures != null && domainContext.MesCoutMesures.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.MesCoutMesures.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<MesCoutMesure> query = domainContext.GetMesCoutMesureWithDependancyQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesCoutMesure> MesCoutMesures = null;
                ...
                {
                    MesCoutMesures = loadOp.Entities;
                    Entities = new ObservableCollection<MesCoutMesure>(MesCoutMesures.ToList().OrderBy(s => s.RefEnumValeur.LibelleCourt));
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<MesCoutMesure> query = domainContext.GetMesCoutMesureByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<MesCoutMesure>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<MesCoutMesure, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);

            EntityQuery<MesCoutMesure> query = domainContext.GetMesCoutMesureQuery();
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesCoutMesure> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<MesCoutMesure>(entities.ToList());
                }
