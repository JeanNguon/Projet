...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<MesUnite>))]
    public class MesUnitesService : IEntityService<MesUnite>
    {
        #region Properties
        ...
        public ObservableCollection<MesUnite> Entities { get; set; }

        public MesUnite DetailEntity { get; set; }
        #endregion

        #region Constructor
        public MesUnitesService()
        {
        }
        #endregion
        ...
        public void Add(MesUnite entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(MesUnite entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<MesUnite> query = domainContext.GetMesUniteQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesUnite> MesUnitess = null;
                ...
                {
                    MesUnitess = loadOp.Entities;
                    Entities = new ObservableCollection<MesUnite>(MesUnitess.ToList().OrderBy(u => u.Libelle));
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<MesUnite> query = domainContext.GetMesUniteByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<MesUnite>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<MesUnite, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesUnite> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<MesUnite>(entities.ToList());
                }
