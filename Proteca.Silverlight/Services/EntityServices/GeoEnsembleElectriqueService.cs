...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<GeoEnsembleElectrique>))]
    public class GeoEnsembleElectriqueService : IEntityService<GeoEnsembleElectrique>
    {
        #region Properties
        ...
        public ObservableCollection<GeoEnsembleElectrique> Entities { get; set; }

        public GeoEnsembleElectrique DetailEntity { get; set; }
        #endregion

        #region Constructor
        public GeoEnsembleElectriqueService()
        {
            Entities = new ObservableCollection<GeoEnsembleElectrique>();
        }
        #endregion
        ...
        public void Add(GeoEnsembleElectrique entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(GeoEnsembleElectrique entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.GeoEnsembleElectriques != null && domainContext.GeoEnsembleElectriques.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.GeoEnsembleElectriques.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<GeoEnsembleElectrique> query = domainContext.GetGeoEnsembleElectriqueQuery().OrderBy(e=>e.Libelle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<GeoEnsembleElectrique> GeoEnsembleElectriques = null;
                ...
                {
                    GeoEnsembleElectriques = loadOp.Entities;
                    Entities = new ObservableCollection<GeoEnsembleElectrique>(GeoEnsembleElectriques.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<GeoEnsembleElectrique> query = domainContext.GetGeoEnsembleElectriqueByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<GeoEnsembleElectrique>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<GeoEnsembleElectrique, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<GeoEnsembleElectrique> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<GeoEnsembleElectrique>(entities.ToList());
                }
