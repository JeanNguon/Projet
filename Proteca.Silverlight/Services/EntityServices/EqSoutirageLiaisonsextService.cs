...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<EqSoutirageLiaisonsext>))]
    public class EqSoutirageLiaisonsextService : IEntityService<EqSoutirageLiaisonsext>
    {
        #region Properties
        ...
        public ObservableCollection<EqSoutirageLiaisonsext> Entities { get; set; }

        public EqSoutirageLiaisonsext DetailEntity { get; set; }
        #endregion

        #region Constructor
        
        public EqSoutirageLiaisonsextService()
        {
        }
        ...
        public void Add(EqSoutirageLiaisonsext entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(EqSoutirageLiaisonsext entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void GetEntities(Action<Exception> completed)
        {
            ...
            {
                this.Entities = new ObservableCollection<EqSoutirageLiaisonsext>();
            }
            completed(null);
        }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<EqSoutirageLiaisonsext> query = domainContext.GetEqSoutirageLiaisonsextByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<EqSoutirageLiaisonsext>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<EqSoutirageLiaisonsext, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);

            EntityQuery<EqSoutirageLiaisonsext> query = domainContext.GetEqSoutirageLiaisonsextQuery();
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<EqSoutirageLiaisonsext> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<EqSoutirageLiaisonsext>(entities.ToList());
                }
