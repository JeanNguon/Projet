...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<HistoAdmin>))]
    public class HistoAdminService : IEntityService<HistoAdmin>
    {
        #region Properties
        ...
        public ObservableCollection<HistoAdmin> Entities { get; set; }

        public HistoAdmin DetailEntity { get; set; }

        public Boolean HasChanges { get { return domainContext != null && domainContext.HistoAdmins.HasChanges; } }

        #endregion

        #region Constructor
        public HistoAdminService()
        {
        }
        #endregion
        ...
        public void Add(HistoAdmin entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(HistoAdmin entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void Clear()
        {
            domainContext.HistoAdmins.Clear();
            this.Entities = new ObservableCollection<HistoAdmin>();
        }
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.HistoAdmins != null && domainContext.HistoAdmins.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.HistoAdmins.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<HistoAdmin> query = domainContext.GetHistoAdminQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<HistoAdmin> HistoAdmins = null;
                ...
                {
                    HistoAdmins = loadOp.Entities;
                    Entities = new ObservableCollection<HistoAdmin>(HistoAdmins.ToList().OrderByDescending(r => r.DateModification));
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<HistoAdmin> query = domainContext.GetHistoAdminByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<HistoAdmin>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void GetEntityByIdentifiant(string identifiant, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);

            EntityQuery<HistoAdmin> query = domainContext.GetHistoAdminByUserQuery(identifiant);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<HistoAdmin, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<HistoAdmin> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<HistoAdmin>(entities.ToList());
                }
