...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<RefNiveauSensibilitePp>))]
    public class RefNiveauSensibilitePpService : IEntityService<RefNiveauSensibilitePp>
    {
        #region Properties
        ...
        public ObservableCollection<RefNiveauSensibilitePp> Entities { get; set; }

        public RefNiveauSensibilitePp DetailEntity { get; set; }
        #endregion

        #region Constructor
        public RefNiveauSensibilitePpService()
        {
            Entities = new ObservableCollection<RefNiveauSensibilitePp>();
        }
        #endregion
        ...
        public void Add(RefNiveauSensibilitePp entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(RefNiveauSensibilitePp entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void Clear()
        {
            //this.domainContext.RefNiveauSensibilitePps.Clear();
            //Entities = new ObservableCollection<RefNiveauSensibilitePp>();
        }
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.RefNiveauSensibilitePps != null && domainContext.RefNiveauSensibilitePps.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.RefNiveauSensibilitePps.EntityContainer.GetChanges())
                {
        ...
        public void GetEntities(Action<Exception> completed)
        {
            ...
            {
                //Entities = new ObservableCollection<RefNiveauSensibilitePp>(domainContext.RefNiveauSensibilitePps.ToList());
                completed(null);
            }
            else
            {
                EntityQuery<RefNiveauSensibilitePp> query = domainContext.GetRefNiveauSensibilitePpQuery();
                domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
                {
                    // Declare error and result
                    Exception error = null;
                    IEnumerable<RefNiveauSensibilitePp> RefNiveauSensibilitePps = null;
                    ...
                    {
                        RefNiveauSensibilitePps = loadOp.Entities;
                        Entities = new ObservableCollection<RefNiveauSensibilitePp>(RefNiveauSensibilitePps.ToList());
                    }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<RefNiveauSensibilitePp> query = domainContext.GetRefNiveauSensibilitePpByCleQuery(cle);
            domainContext.Load(query, loadOp =>
            {
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<RefNiveauSensibilitePp>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<RefNiveauSensibilitePp, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefNiveauSensibilitePp> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<RefNiveauSensibilitePp>(entities.ToList());
                }
