...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<RefUsrAutorisation>))]
    public class RefUsrAutorisationService : IEntityService<RefUsrAutorisation>
    {
        #region Properties
        ...
        public ObservableCollection<RefUsrAutorisation> Entities { get; set; }

        public RefUsrAutorisation DetailEntity { get; set; }
        #endregion

        #region Constructor
        public RefUsrAutorisationService()
        {
        }
        #endregion
        ...
        public void Add(RefUsrAutorisation entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(RefUsrAutorisation entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.RefUsrAutorisations.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.RefUsrAutorisations.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<RefUsrAutorisation> query = domainContext.GetRefUsrAutorisationWithGroupeQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefUsrAutorisation> RefUsrAutorisations = null;
                ...
                {
                    RefUsrAutorisations = loadOp.Entities;
                    Entities = new ObservableCollection<RefUsrAutorisation>(RefUsrAutorisations.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<RefUsrAutorisation> query = domainContext.GetRefUsrAutorisationByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<RefUsrAutorisation>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<RefUsrAutorisation, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefUsrAutorisation> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<RefUsrAutorisation>(entities.ToList());
                }
