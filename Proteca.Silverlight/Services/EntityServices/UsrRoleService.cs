...
namespace Proteca.Silverlight.Services
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<UsrRole>))]
    public class UsrRoleService : IEntityService<UsrRole>
    {
        #region Properties
        ...
        public ObservableCollection<UsrRole> Entities { get; set; }

        public UsrRole DetailEntity { get; set; }
        #endregion
        ...
        public void Add(UsrRole entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(UsrRole entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.UsrRoles.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.UsrRoles.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<UsrRole> query = domainContext.GetUsrRoleQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<UsrRole> UsrRoles = null;
                ...
                {
                    UsrRoles = loadOp.Entities;
                    Entities = new ObservableCollection<UsrRole>(UsrRoles.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<UsrRole> query = domainContext.GetUsrRoleByCleProfilQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<UsrRole>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<UsrRole, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<UsrRole> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<UsrRole>(entities.ToList());
                }
