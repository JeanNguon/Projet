...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<MesNiveauProtection>))]
    public class MesNiveauProtectionService : IEntityService<MesNiveauProtection>
    {
        #region Properties
        ...
        public ObservableCollection<MesNiveauProtection> Entities { get; set; }

        public MesNiveauProtection DetailEntity { get; set; }
        #endregion

        #region Constructor
        public MesNiveauProtectionService()
        {
        }
        #endregion
        ...
        public void Add(MesNiveauProtection entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(MesNiveauProtection entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.MesNiveauProtections != null && domainContext.MesNiveauProtections.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.MesNiveauProtections.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<MesNiveauProtection> query = domainContext.GetMesNiveauProtectionQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesNiveauProtection> MesNiveauProtections = null;
                ...
                {
                    MesNiveauProtections = loadOp.Entities;
                    Entities = new ObservableCollection<MesNiveauProtection>(MesNiveauProtections.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<MesNiveauProtection> query = domainContext.GetMesNiveauProtectionByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<MesNiveauProtection>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<MesNiveauProtection, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<MesNiveauProtection> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<MesNiveauProtection>(entities.ToList());
                }
