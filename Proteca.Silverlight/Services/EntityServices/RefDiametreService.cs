...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<RefDiametre>))]
    public class RefDiametreService : IEntityService<RefDiametre>
    {
        #region Properties
        ...
        public ObservableCollection<RefDiametre> Entities { get; set; }

        public RefDiametre DetailEntity { get; set; }
        #endregion

        #region Constructor
        public RefDiametreService()
        {
        }
        #endregion
        ...
        public void Add(RefDiametre entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(RefDiametre entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.RefDiametres != null && domainContext.RefDiametres.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.RefDiametres.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<RefDiametre> query = domainContext.GetRefDiametreQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefDiametre> RefDiametres = null;
                ...
                {
                    RefDiametres = loadOp.Entities;
                    Entities = new ObservableCollection<RefDiametre>(RefDiametres.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<RefDiametre> query = domainContext.GetRefDiametreByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<RefDiametre>(loadOp.Entities);
                    }
                }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<RefDiametre, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefDiametre> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<RefDiametre>(entities.ToList());
                }
