...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<RefParametre>))]
    public class RefParametreService : IEntityService<RefParametre>
    {
        #region Properties
        ...
        public ObservableCollection<RefParametre> Entities { get; set; }

        public RefParametre DetailEntity { get; set; }
        #endregion

        #region Constructor
        public RefParametreService()
        {
            Entities = new ObservableCollection<RefParametre>();
        }
        #endregion
        ...
        public void Add(RefParametre entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(RefParametre entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void Clear()
        {
            this.domainContext.RefParametres.Clear();
            this.Entities = new ObservableCollection<RefParametre>();
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.RefParametres.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.RefParametres.EntityContainer.GetChanges())
                {
        ...
        public void GetEntities(Action<Exception> completed)
        {
            ...
            {
                EntityQuery<RefParametre> query = domainContext.GetRefParametreQuery();
                domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
                {
                    // Declare error and result
                    Exception error = null;
                    IEnumerable<RefParametre> RefParametres = null;
                    ...
                    {
                        RefParametres = loadOp.Entities;
                        Entities = new ObservableCollection<RefParametre>(RefParametres.ToList());
                    }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            this.DetailEntity = this.Entities != null ? this.Entities.Where(a => a.CleParametre == cle).FirstOrDefault() : null;
            // aucun traitement a effectuer pour une région
            completed(null);
        }
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<RefParametre, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefParametre> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<RefParametre>(entities.ToList());
                }
