...
namespace Proteca.Silverlight.Services
{
    ...
    /// 
    /// </summary>
    [Export(typeof(IEntityService<RefUsrGroupe>))]
    public class RefUsrGroupeService : IEntityService<RefUsrGroupe>
    {
        #region Properties
        ...
        public ObservableCollection<RefUsrGroupe> Entities { get; set; }

        public RefUsrGroupe DetailEntity { get; set; }
        #endregion

        #region Constructor
        public RefUsrGroupeService()
        {
        }
        #endregion
        ...
        public void Add(RefUsrGroupe entity)
        {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void Delete(RefUsrGroupe entity)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntitySet es = domainContext.EntityContainer.GetEntitySet(entity.GetType());
            es.Remove(entity);
        ...
        public void SaveChanges(Action<Exception> completed)
        {
            ...
            if (domainContext.RefUsrGroupes.HasChanges)
            {
                bool isValid = true;
                foreach (var obj in domainContext.RefUsrGroupes.EntityContainer.GetChanges())
                {
        ...
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<RefUsrGroupe> query = domainContext.GetRefUsrGroupeQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefUsrGroupe> RefUsrGroupes = null;
                ...
                {
                    RefUsrGroupes = loadOp.Entities;
                    Entities = new ObservableCollection<RefUsrGroupe>(RefUsrGroupes.ToList());
                }
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            EntityQuery<RefUsrGroupe> query = domainContext.GetRefUsrGroupeByCleQuery(cle);
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                ...
                else
                {
                    ...
                    {
                        Entities = new ObservableCollection<RefUsrGroupe>(loadOp.Entities);
                    }
                }
        ...
        /// <summary>
        /// Récupère une seule entité en fonction du profil
        /// </summary>
        /// <param name="cle">clé de l'entité</param>
        /// <param name="completed">callback fonction</param>
        public void GetEntitiesByCleProfil(int cle, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            EntityQuery<RefUsrGroupe> query = domainContext.GetRefUsrGroupeQuery();
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
        ...
        /// <param name="completed">callback fonction</param>
        public void FindEntities(List<Expression<Func<RefUsrGroupe, bool>>> filtres, Action<Exception> completed)
        {
            Logger.Log(LogSeverity.Information, GetType().FullName, MethodBase.GetCurrentMethod().Name);
            ...
            domainContext.Load(query, LoadBehavior.MergeIntoCurrent, loadOp =>
            {
                // Declare error and result
                Exception error = null;
                IEnumerable<RefUsrGroupe> entities = null;
                ...
                else
                {
                    ...
                    Entities = new ObservableCollection<RefUsrGroupe>(entities.ToList());
                }
