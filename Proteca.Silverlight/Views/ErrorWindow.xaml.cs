namespace Proteca.Silverlight
{
    ...
    public partial class ErrorWindow : ChildWindow
    {
        ...
        protected ErrorWindow(string message, string errorDetails)
        {
            ...
            ContentStackPanel.Visibility = String.IsNullOrWhiteSpace(errorDetails) ? System.Windows.Visibility.Collapsed : System.Windows.Visibility.Visible;
        }
        ...
        public static ErrorWindow CreateNew(Exception exception, StackTracePolicy policy)
        {
            ...
            {
                fullStackTrace += "\n" + string.Format(System.Globalization.CultureInfo.CurrentUICulture, Resource.ErrorWindowInnerException, innerException.Message) + "\n\n" + innerException.StackTrace;
                innerException = innerException.InnerException;
            }

            return CreateNew(ConvertExceptionToMessage(exception), fullStackTrace, policy);
        }
