...
{
    [ExportAsView("Equipement_RI")]
    [ExportViewToRegion("Equipement_RI", "MainContainer")]
    public partial class Equipement_RIView : Page
    {

        public Equipement_RIView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_RI", "Equipement_RI");
            }
        }
