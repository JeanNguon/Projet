...
{
    [ExportAsView("Equipement_SO")]
    [ExportViewToRegion("Equipement_SO", "MainContainer")]
    public partial class Equipement_SOView : Page
    {

        public Equipement_SOView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_SO", "Equipement_SO");
            }
        }
