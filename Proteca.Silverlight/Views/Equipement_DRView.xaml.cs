...
{
    [ExportAsView("Equipement_DR")]
    [ExportViewToRegion("Equipement_DR", "MainContainer")]
    public partial class Equipement_DRView : Page
    {

        public Equipement_DRView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_DR", "Equipement_DR");
            }
        }
