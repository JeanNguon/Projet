...
{
    [ExportAsView("Equipement_TC")]
    [ExportViewToRegion("Equipement_TC", "MainContainer")]
    public partial class Equipement_TCView : Page
    {

        public Equipement_TCView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_TC", "Equipement_TC");
            }
        }
