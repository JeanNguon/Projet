...
{
    [ExportAsView("Equipement_AG")]
    [ExportViewToRegion("Equipement_AG", "MainContainer")]
    public partial class Equipement_AGView : Page
    {

        public Equipement_AGView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_AG", "Equipement_AG");
            }
        }
