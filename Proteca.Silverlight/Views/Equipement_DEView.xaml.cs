...
{
    [ExportAsView("Equipement_DE")]
    [ExportViewToRegion("Equipement_DE", "MainContainer")]
    public partial class Equipement_DEView : Page
    {

        public Equipement_DEView()
        {
            InitializeComponent();
        }
        ...
        public ViewModelRoute Binding
        {
            get
            {
                return ViewModelRoute.Create("Equipement_DE", "Equipement_DE");
            }
        }
