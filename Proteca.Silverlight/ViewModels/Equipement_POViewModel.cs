...
{
    /// <summary>
    /// ViewModel for Equipement_PO entity
    /// </summary>
    [ExportAsViewModel("Equipement_PO")]
    public class Equipement_POViewModel : EquipementViewModel
    {
        #region Constructor
        ...
        /// </summary>
        public Equipement_POViewModel(): base()
        {
            this.OnViewActivated += (o, e) =>
            {
                ...
                if (!e.ViewParameter.Any(p => p.Key == "IsExpanderLoaded"))
                {
                    ...
                    EventAggregator.Publish("Equipement_Expander".AsViewNavigationArgs().AddNamedParameter("IsExpanderLoaded", true).AddNamedParameter(Constants.SPECIFIC_VIEWMODEL_NAME, "Equipement_PO"));
                }
            };
        ...
        public override void LoadDetailEntity()
        {
            ...
            IsBusy = true;
            ((EqEquipementService)service).GetEntityByCle<EqPostegaz>(SelectedId.Value, (error) => DetailEntityLoaded(error));
        }
