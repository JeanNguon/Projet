...
namespace Jounce.Framework.Services
{
    ...
    public class ApplicationService : IApplicationService, IApplicationLifetimeAware, IDisposable
    {
        ...
        private LogSeverity _severity = LogSeverity.Error;
        ...
        public void Starting()
        {
            ...
            if (viewInfo != null && Views.Count(v => v.Metadata.IsShell) == 1)
            {
            ...
            {
                Logger.Log(LogSeverity.Warning, GetType().FullName, "There is no shell or more than one shell declared.");
            }
        }
