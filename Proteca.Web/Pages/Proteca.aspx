...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
          ...
          <param name="initParams" value="Jounce.LogLevel=Information,DebugLogin=n.cossard,MicadoURL=http://micado.grtgaz.com" /><%--COSSARD:n.cossard; CHAUMY:1002QQ; BLONDEAU:3112C9; RAMIER: 1242XR, VIDAL(suivi secteur): 1063JE--%>
