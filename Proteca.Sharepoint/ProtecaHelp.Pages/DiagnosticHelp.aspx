...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server"> 
    ...
    <SharePoint:ScriptLink language="javascript" name="Proteca/Scripts/DiagnosticHelp.js" LoadAfterUI="false" OnDemand="false" Localizable="false" runat="server"/>
</asp:Content>

<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <h2 id="title">Aide au diagnostic</h2>
