...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
    <div id="AccueilXAPZone">
        <WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_Top%>" ID="XAPMainZone">
            <ZoneTemplate></ZoneTemplate>
        </WebPartPages:WebPartZone>
    </div>
    <div id="AccueilMainZone">
        <table cellpadding="4" cellspacing="0" border="0" class="AccueilPage">
		<tr>			
			<td id="tdWebPartZoneTopLeftRow" name="_invisibleIfEmpty" valign="top" class="AccueilLeftBar">                
                    <WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" ID="TopLeftRow">
                        <ZoneTemplate></ZoneTemplate>
                    </WebPartPages:WebPartZone>
            </td>
			<td id="tdPublishingPageContent" name="_invisibleIfEmpty" valign="top" class="AccueilMainContent"> 
				<PublishingWebControls:RichHtmlField id="PageContent" FieldName="PublishingPageContent" runat="server"/>
            </td>
            <td id="tdWebPartZoneTopRightRow" name="_invisibleIfEmpty" valign="top" class="AccueilRightBar"> 
        ...
        <PublishingWebControls:EditModePanel runat="server" id="EditModePanelDiplayed" PageDisplayMode="Display" >
            <script language="javascript">
                document.getElementById('AccueilXAPZone').style.display = "block";
                document.getElementById('tdWebPartZoneTopLeftRow').style.display = "block";
                document.getElementById('tdWebPartZoneTopRightRow').style.display = "block";
            </script>
        </PublishingWebControls:EditModePanel>
        <PublishingWebControls:EditModePanel runat="server" id="EditModePanelEdit" PageDisplayMode="Edit" >
            <script language="javascript">
                document.getElementById('AccueilXAPZone').style.display = "none";
                document.getElementById('tdWebPartZoneTopLeftRow').style.display = "none";
                document.getElementById('tdWebPartZoneTopRightRow').style.display = "none";
            </script>
        </PublishingWebControls:EditModePanel>
	</table>
    </div>	
