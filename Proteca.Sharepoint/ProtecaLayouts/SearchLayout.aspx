...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" ID="SearchResultZone">
        <ZoneTemplate></ZoneTemplate>
    </WebPartPages:WebPartZone>

    <script language="javascript" type="text/javascript">
        if(document.getElementById("ProtecaHeader"))
        {
            document.getElementById("ProtecaHeader").style.display = "none";
        }
        if (document.body) {
