...
namespace Proteca.Silverlight.Services.EntityServices
{
    ...
    public class EqSoutirageLiaisonsextService : IEntityService<EqSoutirageLiaisonsext>
    {
        ...
        public void GetEntityByCle(int cle, Action<Exception> completed)
        {
            ...
            var query = domainContext.EqSoutirageLiaisonsexts.FirstOrDefault(e => e.CleSoutirageLext == cle);
            ...
            {
                Entities = new ObservableCollection<EqSoutirageLiaisonsext>(new List<EqSoutirageLiaisonsext>() { query });
            }
        ...
        public void FindEntities(List<Expression<Func<EqSoutirageLiaisonsext, bool>>> filtres, Action<Exception> completed)
        {
            ...
            var query = domainContext.EqSoutirageLiaisonsexts.AsQueryable();
